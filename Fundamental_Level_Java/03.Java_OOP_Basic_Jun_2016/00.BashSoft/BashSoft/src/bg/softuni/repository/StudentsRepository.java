...
public class StudentsRepository {
    ...
    public LinkedHashMap<String, Course> courses;
    public LinkedHashMap<String, Student> students;
        ...
        for (String line : lines) {
            ...
            if (!line.isEmpty() && matcher.find()) {
                ...
                try {
                    ...
                    throw new NumberFormatException(nfex.getMessage() + " at line: " + 72);
                }
            }
        }
    ...
    public void getStudentMarkInCourse(String courseName, String studentName) {
        ...
        Double mark = this.courses.get(courseName).getStudentsByName().get(studentName).
