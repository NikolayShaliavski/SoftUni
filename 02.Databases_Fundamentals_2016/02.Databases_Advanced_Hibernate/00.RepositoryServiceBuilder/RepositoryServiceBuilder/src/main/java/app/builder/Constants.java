...
public class Constants {
    ...
    public static final String SERVICE_INTERFACE_METHOD = "    void save(%s %s);";
    ...
    public static final String SERVICE_METHOD = "    public void save(%s %s) {";
    public static final String FIELD_INVOCATION = "        this.%s.saveAndFlush(%s);";
    public static final String SERVICE_IMPL_POSTFIX = "ServiceImpl";
    public static final String INDENTED_CLOSE_BRACKET = "    }";
}
