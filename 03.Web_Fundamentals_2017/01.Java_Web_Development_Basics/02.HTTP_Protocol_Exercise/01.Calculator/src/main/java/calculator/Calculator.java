...
public class Calculator {
    ...
    private static final String PROJECT_HTML_PATH =
            "E:\\GitHub\\SoftUni\\03.Web_Fundamentals_2017" +
            "\\01.Java_Web_Development_Basics\\02.HTTP_Protocol_Exercise\\" +
                    "01.Calculator\\src\\main\\resources\\static\\html\\calculator.html";

    public static void main(String[] args) {
        printContentType();
        String html = HTMLReader.readHTML(PROJECT_HTML_PATH);
